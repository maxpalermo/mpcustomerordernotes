...
require_once $current_path.'/classes/HTMLTemplateOrderPDF.php';
require_once $current_path.'/mpcustomerordernotes.php';

if (Tools::isSubmit('ajax') && Tools::getValue('action', '') == 'uploadAttachment') {
    $module = new MpCustomerOrderNotes();
    $module->ajaxProcessUploadAttachment();
}
